...
void main() {
  ...
  print(
    'String After Replace With Out Case Sensitive is :\n ${customReplaceAll(stringText, stringToReplace, stringReplaceWith, false)}',
  );

  print(
    'String After Replace With Case Sensitive is :\n ${customReplaceAll(stringText, stringToReplace, stringReplaceWith)}',
  );
}
